...
public class ScapegoatTree<Key extends Comparable<Key>, Value> {
    ...
    */
    ...
    /* Function for reorder traversal */
    ...
    private void preOrder(Node<Key,Value> root, List<Node<Key,Value>> nodes) {
        if(root != null) {
            nodes.add(root);
    ...
    private void postOrder(Node<Key,Value> root, List<Node<Key,Value>> nodes) {
        if(root != null) {
    ...
    public Key successor(Key key) {
        ...
        if (root == null) {
            ...
            Node<Key,Value> par = node.parent;
